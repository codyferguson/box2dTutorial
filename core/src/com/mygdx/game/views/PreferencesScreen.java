...
public class PreferencesScreen implements Screen {
    ...
    public void show() {
        ...
        final TextButton backButton = new TextButton("Back", skin, "small");// the extra argument here
        // "small" is used to set the button to the smaller version instead of the big default version
